...
def crawl(site_key, keyword, pages=2):
    ...
    for page in range(1, pages + 1):
        ...
        print(f"크롤링 중: {site['name']} 페이지 {page} -> {url}")
    ...
    if all_jobs:
        ...
        print("추출된 공고가 없습니다. 선택자 또는 구조를 확인하세요.")

if __name__ == "__main__":
    print("사용 가능한 사이트:", ", ".join(list(sites.keys())))
    site = input("크롤링할 사이트 선택 (saramin/jobkorea): ").strip()
